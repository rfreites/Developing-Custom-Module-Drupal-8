...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__vendors_androidStockBrowsers__ = __webpack_require__(7);
...
__WEBPACK_IMPORTED_MODULE_0_jquery___default()(function () {
  Object(__WEBPACK_IMPORTED_MODULE_2__vendors_androidStockBrowsers__["a" /* default */])();

  // Get page name using class
  var page = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('body').attr('class');

  if (page) {
    switch (page.split(' ')[0]) {
      case __WEBPACK_IMPORTED_MODULE_1__helpers___["a" /* prefix */] + '-p-home':
        {
...
/* unused harmony export apiInstagram */
/* unused harmony export apiTwitter */
/* unused harmony export apiMedium */
/**
...
var apiInstagram = api + '/instagram';

var apiTwitter = api + '/twitter';

var apiMedium = api + '/medium';
...
/* unused harmony export imagesPath */
/* unused harmony export imageOptionLocalStorage */
var prefix = 'bootstrap_sass';
var imagesPath = '../images';
var imageOptionLocalStorage = 'image-local-storage';
...
/* unused harmony export matchHeight */
/* unused harmony export stickySupport */
/**
...
/**
 * Uses jquery responsive equal heigth
 */
...
/**
 *  Check if browser supports position 'sticky' for elements
 */
...
/* harmony default export */ __webpack_exports__["a"] = (function () {
    ...
    if (isAndroid) {
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()('select.form-control').removeClass('form-control').css('width', '100%');
    }
});
